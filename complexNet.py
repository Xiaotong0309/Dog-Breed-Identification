...
archive_train = ZipFile("dog_dataset/train.zip", 'r')
archive_test = ZipFile("dog_dataset/test.zip", 'r')
...
labels_raw = pd.read_csv("dog_dataset/labels.csv", header=0, sep=',', quotechar='"')
